...
Public Sub SendWeeklyReportReminder()
    ...
    If emailList = vbNullString Then
        MsgBox "Keine gültigen E-Mail-Adressen gefunden." & vbNewLine & vbNewLine & _
               ...
               vbExclamation, "Keine EmpfÃ¤nger"
        GoTo CleanupAndExit
    End If
    ...
    '--- causing umlauts (Ã¤, Ã¶, ü) to display as wrong characters
...
CleanupAndExit:
    ...
    If emailCount > 0 Then
        ...
        successMessage = "E-Mail an " & emailCount & " EmpfÃ¤nger wurde erstellt."
